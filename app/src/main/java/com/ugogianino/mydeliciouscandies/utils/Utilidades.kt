...
class Utilidades {
    ...
    fun validateInputs(name: String, manufacturer: String, candyType: String, format: String, sweetness: String, url: String): Boolean {
        ...
        if (!sweetnessRegex.matches(sweetness)) {
            Toast.makeText(applicationContext, "Sweetness must be a number between 1 and 5", Toast.LENGTH_SHORT).show()
            return false
        }
